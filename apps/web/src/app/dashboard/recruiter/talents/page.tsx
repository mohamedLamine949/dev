...
import { 
    ...
    Globe, User as UserIcon, Star, ArrowRight, X, ChevronDown, Check
} from 'lucide-react';
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 font-medium">Trouvez les meilleurs candidats pour vos besoins futurs</p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-500 border border-white/10 rounded-lg px-3 py-1.5 cursor-pointer hover:bg-white/5 transition-colors">
                        ...
                        {loading ? (
                            ...
                            <div className="bg-white/[0.02] border border-dashed border-white/10 rounded-[32px] p-24 text-center">
                                ...
                                <p className="text-gray-500 max-w-xs mx-auto">Essayez de modifier vos filtres ou d&apos;élargir votre recherche par mots-clés.</p>
                            </div>
                        ) : (
                            <motion.div 
                                ...
                                {talents.map(talent => (
                                    ...
                                    >
                                        ...
                                        <div className="mt-auto pt-5 border-t border-white/[0.05] flex items-center justify-between">
                                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-600">Disponibilité : <span className="text-gray-400">{talent.candidateProfile?.availability || 'À débattre'}</span></span>
