...
const styles = StyleSheet.create({
    ...
    scoreTitle: { color: '#fff', fontSize: 14, fontWeight: 'bold', marginBottom: 8 },
    scoreBarBg: { height: 8, backgroundColor: '#333', borderRadius: 4, marginVertical: 8, overflow: 'hidden' },
