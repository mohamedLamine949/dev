# 🇲🇱 MaliTravail - Plateforme d'Emploi Moderne

MaliTravail est une plateforme de recrutement innovante dédiée au marché malien, offrant une expérience fluide pour les candidats et les recruteurs.
...
3. **Configuration de la Base de Données (Supabase)**
   ...
   - Créez un nouveau projet (ex: "MaliTravail").
